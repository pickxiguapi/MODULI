...
if __name__ == "__main__":
    ...
    parser.add_argument("--pipeline_name", type=str, default="mo_dd_wo_norm")
    ...
    parser.add_argument("--cond_val", type=float, default=0.75,
    ...
    if args.mode == "train":
        ...
        for batch in loop_dataloader(dataloader):
            ...
            val = batch["score"][:, 0, :].to(args.device)
            pref = batch["pref"].to(args.device)

            return_scale = front(pref).detach()
