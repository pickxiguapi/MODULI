...
if __name__ == "__main__":
    ...
    if args.nn == "dit":
        ...
        nn_classifier = HalfDiT1d(
            obs_dim + act_dim, out_dim=pref_dim, emb_dim=args.emb_dim, d_model=args.d_model//2, n_heads=args.n_heads, depth=max(args.depth//2, 1),
            timestep_emb_type=args.time_emb_type).to(args.device)
    elif args.nn == "unet":
    ...
    classifier = MOCumRewClassifier(nn_classifier, device=args.device, scale_param=1.)
