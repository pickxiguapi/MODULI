...
def inference(
    ...
    condition = torch.clone(eval_prefs).to(args.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pipeline_name", type=str, default="mo_dd_wo_score")
    ...
    parser.add_argument("--n_gradient_steps", type=int, default=500_000)
    ...
    if args.mode == "train":
        ...
        for batch in loop_dataloader(dataloader):
            ...
            log["avg_loss_diffusion"] += agent.update(obs, pref)['loss']
