    ...
    for ep in range(args.num_episodes):
        ...
        while idx < args.num_prefs:
            ...
            while not np.all(cum_dones) and t <= 500:
                ...
                # sample trajectories
                prior = torch.zeros((current_num_envs, args.horizon, args.obs_dim), device=args.device)
                prior[:, 0, :args.obs_dim] = obs
...
def main():
    ...
    args.obs_dim, args.act_dim, args.pref_dim = obs_dim, act_dim, pref_dim
