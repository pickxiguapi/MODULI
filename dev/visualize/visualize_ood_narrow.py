...
axs[2].scatter(d4morl_data[::100, 0], d4morl_data[::100, 1], edgecolor='lightgrey', facecolor='none')
...
axs[0].scatter(slider_data[use_indices, 0], slider_data[use_indices, 1], edgecolor='royalblue', facecolor='none')
# axs[0].scatter(slider_data[:, 0], slider_data[:, 1], edgecolor='royalblue', facecolor='none')
...
axs[1].scatter(rvs_data[use_indices, 0], rvs_data[use_indices, 1], edgecolor='royalblue', facecolor='none')
...
axs[2].scatter(bc_data[use_indices, 0], bc_data[use_indices, 1], color='crimson', facecolor='none')
# axs[2].scatter(bc_data[:, 0], bc_data[:, 1], edgecolor='royalblue', facecolor='none')

axs[0].set_title("MODULI", fontsize=20)
axs[1].set_title("MORvS(P)", fontsize=20)
axs[2].set_title("BC(P)", fontsize=20)
...
# d4morl_data = np.load(f"dev/data/raw_rewards/MO-Hopper-v3_50000_amateur_uniform.npy")
# # delete 6-th ax
...
# diff_data = np.load(f"results/mo_dd/MO-Hopper-v3_50000_amateur_uniform/eval_standard/22M/eval_reward_.npy")
# diff_data = diff_data.mean(axis=0)
