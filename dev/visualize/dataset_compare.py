...
# ------------- RvS
data = np.load(f"dev/data/raw_rewards_50/MO-{dataset_name}-v2_50000_{dataset_type}_uniform.npy")
...
# -------------- Diff
# data = np.load(f"dev/data/raw_rewards_50/MO-{dataset_name}-v2_50000_{dataset_type}_uniform.npy")
# axs[4].scatter(data[::20, 0], data[::20, 1], facecolor='lightgrey', lw=0.2)
...
axs[3].scatter(diff_data[:, 0], diff_data[:, 1], edgecolor='crimson', facecolor='none')
