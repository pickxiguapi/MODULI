...
# nohup python -u dev/mo_pipelines/mo_dd_wo_norm_3obj.py --device cuda:7 --save_name model/11M --mode train --force_override True --dataset_name MO-Hopper-v3_50000_amateur_uniform --uniform --redirect &
# nohup python -u dev/mo_pipelines/mo_dd_wo_norm_3obj.py --device cuda:7 --save_name model/11M --mode train --force_override True --dataset_name MO-Hopper-v3_50000_expert_uniform --uniform --redirect & wait

# nohup python -u dev/mo_pipelines/mo_dd_3obj.py --device cuda:7 --eps 0 --save_name model/11M_global_norm --mode train --force_override True --dataset_name MO-Hopper-v3_50000_amateur_uniform --uniform --redirect &
# nohup python -u dev/mo_pipelines/mo_dd_3obj.py --device cuda:7 --eps 0 --save_name model/11M_global_norm --mode train --force_override True --dataset_name MO-Hopper-v3_50000_expert_uniform --uniform --redirect & wait
