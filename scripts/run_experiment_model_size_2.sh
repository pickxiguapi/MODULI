...
# nohup python -u dev/mo_pipelines/mo_dd.py --save_name model/16M --dataset_name MO-Hopper-v2_50000_amateur_uniform      --n_heads 6 --d_model 384 --depth 6 --uniform --device cuda:3 --redirect &
# nohup python -u dev/mo_pipelines/mo_dd.py --save_name model/16M --dataset_name MO-Hopper-v2_50000_expert_uniform      --n_heads 6 --d_model 384 --depth 6 --uniform --device cuda:3 --redirect & wait
...
nohup python -u dev/mo_pipelines/mo_dd.py --save_name model/11M --dataset_name MO-Hopper-v2_50000_amateur_uniform      --n_heads 6 --d_model 384 --depth 4 --uniform --device cuda:3 --redirect &
nohup python -u dev/mo_pipelines/mo_dd.py --save_name model/11M --dataset_name MO-Hopper-v2_50000_expert_uniform      --n_heads 6 --d_model 384 --depth 4 --uniform --device cuda:3 --redirect & wait
...
nohup python -u dev/mo_pipelines/mo_dd.py --save_name model/11M --dataset_name MO-Walker2d-v2_50000_amateur_uniform    --n_heads 6 --d_model 384 --depth 4 --uniform --device cuda:2 --redirect &
nohup python -u dev/mo_pipelines/mo_dd.py --save_name model/11M --dataset_name MO-Walker2d-v2_50000_expert_uniform    --n_heads 6 --d_model 384 --depth 4 --uniform --device cuda:2 --redirect & wait